      ...
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          ...
          <Box sx={{ marginLeft: "auto" }}>
            <IconButton size="large" onClick={handleOpenLangMenu} color="inherit">
              <LangIcon />
            </IconButton>
            <MenuList id="menu-lang" openEl={anchorElLang} onClose={handleCloseLangMenu} onOpen={switchLang} items={Object.entries(lauguages)} />
            <IconButton size="large" onClick={handleOpenNavMenu} color="inherit" sx={{ display: { md: "none" } }}>
              <MenuIcon />
            </IconButton>
            <MenuList id="menu-appbar" openEl={anchorElNav} onClose={handleCloseNavMenu} onOpen={switchPage} sx={{ display: { md: "none" } }} items={pages} />
          </Box>
        </Toolbar>
      </Container>
    </AppBar>
